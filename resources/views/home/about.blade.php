...
<!-- Hero Section -->
    ...
    <section class="bg-light py-5">
        <div class="container text-center">
            ...
            <a href="{{route('home.index')}}" class="btn btn-primary btn-lg px-4 me-2">Get Started</a>
            <a href="{{route('home.contact')}}" class="btn btn-outline-primary btn-lg px-4">Contact Us</a>
        </div>
    </section>
@endsection
